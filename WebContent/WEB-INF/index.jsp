				...
				<div class="left_cont_rech">
					<div class="filtre_cat">
						...
						<div
							...
							<div class="achats">
								<input type="radio" name="choixFiltre" id="achats"
							...
							<div class="Ventes">
								<input type="radio" name="choixFiltre" id="ventes"
			...
			<c:forEach items="${articleModel.lstCard}" var="article">
				<div class="card">
					<img src="./img/horloge.jpg" alt=""
						style="object-fit: contain; width: 100%; height: 200px; border: solid 1px #CCC">
					<div class="textArticle">
						<form action="AccueilServlet" method="POST">
							<input type="hidden" name="idArticle"
								value="${article.noArticle}"> <input
								class="link nomArticle" type="submit" name="btn_Article"
								value="${article.nomArticle}"  <c:if test="${utilisateurModel == null}"> disabled</c:if>>
						</form>
						<div class="box_card">
							<p>Prix :</p>
						...
						<div class="vendeur box_card">
							<p>Vendeur :</p>
							<input class="link btn_vendeur" type="submit"
								name="pseudoVendeur" value="${article.nomVendeur}" />
						</div>
					</div>
				</div>
			</c:forEach>
