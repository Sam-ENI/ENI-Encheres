...
<body>
    <header>
        ...
        <form action="AccueilServlet" method="POST">
            <!-- Si utilisater déconnectée-->
            <input class="link " type="submit" name="insci/connex" value="S'inscrire - Se connecter">
            <!-- Si utilisateur connectée -->
            <nav class="nav  link hidden">
            ...
            <div class="card">
                ...
                <div>
                    ...
                    <form action="profilServlet">
                       Vendeur : <input class="link" type="submit" name="pseudoVendeur" value="[PSEUDO VENDEUR]" />
                    </form>
                </div>
            </div>
            <div class="card">
